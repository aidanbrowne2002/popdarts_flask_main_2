...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\aidan\PycharmProjects\popdarts_flask'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\aidan\PycharmProjects\popdarts_flask\Scripts\deactivate.nu'
